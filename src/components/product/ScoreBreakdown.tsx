...
export function ScoreBreakdown({
  ...
  return (
    <div className="space-y-6">
      <Callout tone="neutral" title="What the PowerMatch Score is">
      ...
      <div className="flex flex-col items-start gap-6 sm:flex-row sm:items-center">
        <ScoreCircle value={score.overall} band={score.band} size={104} />
        <div className="text-sm text-navy-600">
          ...
          {score.overall == null ? (
            <p className="mt-1 font-medium text-warn-DEFAULT">
      ...
      <div className="space-y-3">
        {score.dimensions.map((d) => (
          <div key={d.key}>
            <ScoreBar value={d.score} label={d.label} sublabel={d.basis} />
          </div>
        ))}
